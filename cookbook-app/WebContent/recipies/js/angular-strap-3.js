      ...
      return {
        ...
        link: function postLink(scope, element, attr, ctrl) {
          ...
          $q.when(options.content || $templateCache.get(value) || $http.get(value, { cache: true })).then(function onSuccess(template) {
            ...
            var popover = element.data('bs.popover');	// SN -- Modifier 'bpopover' pour 'bs.popover'
            ...
            popover.getPosition = function () {
              ...
              scope.$digest();
              this.$tip.data('bs.popover', this);	// SN -- Modifier 'bpopover' pour 'bs.popover'
              return r;
            };
            ...
            angular.forEach([
              ...
              element.on(name, function (ev) {
                scope.$emit('bs.popover-' + name, ev);	// SN -- Modifier 'bpopover-' pour 'bs.popover-'
              });
            });
          });
        }
